        ...
        <div class="bg-white rounded border border-neutral-200/20">
            <div class="p-4 space-y-6">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        <h3 class="text-lg font-medium text-gray-900 ml-4">Profile Photo</h3>
                        <p class="text-sm text-gray-500 ml-4">JPG, GIF or PNG. Max size of 800K</p>
                    </div>
                </div>
                ...
                <form class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="email" class="mt-1 block w-full border border-neutral-400 rounded py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500" value="john@example.com" readonly>
                    </div>
                    ...
                    <div class="flex justify-end space-x-3 pt-6">
                        <a href="../../app/controller/signout.php" class="px-4 py-2 border bg-red-600 rounded text-white hover:bg-red-600">LogOut</a>
