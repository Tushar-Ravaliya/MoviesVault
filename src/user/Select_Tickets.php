                              ...
                              <?php foreach ($screen_types as $screen_type => $showtimes): ?>
                                   <div class="mb-4 last:mb-0">
                                        <div class="flex items-center mb-2">
                                             <span class="text-sm font-medium text-gray-700 bg-gray-100 px-3 py-1 rounded-full"><?php echo htmlspecialchars($screen_type); ?></span>
                                        </div>

                                        <div class="flex flex-wrap gap-3">
                                             <?php foreach ($showtimes as $showtime): ?>
                                                  <div class="showtime-item" data-date="<?php echo date('Y-m-d', strtotime($showtime['date'])); ?>">
                                                       <a href="Book_ticket.php?showtime_id=<?php echo $showtime['id']; ?>" class="group">
                                                            <div class="flex flex-col items-center transition-transform hover:scale-105">
                                                                 <div class="text-sm text-gray-500 mb-1"><?php echo $showtime['date']; ?></div>
                                                                 <div class="text-green-600 font-medium border-2 border-green-500 hover:bg-green-500 hover:text-white transition-colors px-5 py-2 rounded-md text-center">
                                                                      <?php echo $showtime['time']; ?>
                                                                 </div>
                                                                 <div class="text-xs mt-2 flex items-center justify-center gap-1">
                                                                      <span class="text-gray-700 font-medium"><?php echo $showtime['screen']; ?></span>
