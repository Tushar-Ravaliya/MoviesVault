                ...
                <div class="bg-white rounded-lg border border-neutral-200/30 overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex space-x-2">
                            <a href="editMovie.php?id=<?php echo $movie['movie_id']; ?>" class="flex-1 px-3 py-2 text-sm bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-colors text-center">Edit</a>
                            <button class="flex-1 px-3 py-2 text-sm bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors"
                                onclick="confirmDelete(<?php echo $movie['movie_id']; ?>, '<?php echo addslashes($movie['title']); ?>')">Remove</button>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
