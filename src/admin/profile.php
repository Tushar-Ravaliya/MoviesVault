...
<div id="profile_management" class="p-6">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center space-x-6">
            <div class="relative">
                <img src="../../public/profile/profile-pic.png" alt="Profile" class="w-24 h-24 rounded-full border border-neutral-400">
                    ...
                    <div class="pt-6 border-t border-neutral-400">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="password" name="password" class="mt-1 block w-full border border-neutral-400 rounded py-2 px-3 text-gray-700">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Confirm New Password</label>
                                <input type="password" name="confirm_password" class="mt-1 block w-full border border-neutral-400 rounded py-2 px-3 text-gray-700">
                            </div>
                        </div>
                    </div>
