...
<body class="font-inter overflow-hidden">
    <section class="flex justify-center relative">
      <img src="../Images/background_image_for_login.jpeg" alt="gradient background image" class="w-full h-full object-cover fixed">
      <div class="mx-auto max-w-lg px-6 lg:px-8 absolute py-20">
        ...
        <div class="rounded-2xl bg-white shadow-xl">
          <form action="" class="lg:p-11 p-7 mx-auto">
            ...
            <a href="javascript:;" class="flex justify-center text-gray-900 text-base font-medium leading-6"> Don't have an account? <span class="text-indigo-600 font-semibold pl-3"> Sign Up</span>
            </a>
          </form>
        </div>
      </div>
